...
ActiveRecord::Schema[7.1].define(version: 2025_08_30_105520) do
  create_schema "tiger"
  ...
  create_table "events", force: :cascade do |t|
    ...
    t.index ["pandal_id"], name: "index_events_on_pandal_id"
  ...
  create_table "favorites", id: false, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["pandal_id"], name: "index_favorites_on_pandal_id"
    t.index ["user_id", "pandal_id"], name: "index_favorites_on_user_id_and_pandal_id", unique: true
  ...
  create_table "pandal_images", force: :cascade do |t|
    t.bigint "pandal_id", null: false
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["pandal_id"], name: "index_pandal_images_on_pandal_id"
  end

  create_table "pandal_nearbies", id: false, force: :cascade do |t|
    t.bigint "pandal_id", null: false
    t.string "poi_type", null: false
    t.bigint "poi_id", null: false
    t.integer "distance_m"
    t.index ["pandal_id", "poi_type", "poi_id"], name: "idx_pandal_nearby_unique", unique: true
    t.index ["pandal_id"], name: "index_pandal_nearbies_on_pandal_id"
  end

  create_table "pandals", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["venue_id", "year"], name: "index_pandals_on_venue_id_and_year", unique: true
    t.index ["venue_id"], name: "index_pandals_on_venue_id"
  end
  ...
  create_table "plan_stops", force: :cascade do |t|
    t.bigint "plan_id", null: false
    t.bigint "pandal_id", null: false
    t.integer "stop_order", null: false
    t.datetime "target_arrival"
    t.datetime "target_departure"
    t.string "chosen_mode"
    t.integer "est_travel_min"
    t.decimal "est_travel_cost", precision: 8, scale: 2
    t.text "notes"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["pandal_id"], name: "index_plan_stops_on_pandal_id"
    t.index ["plan_id", "stop_order"], name: "index_plan_stops_on_plan_id_and_stop_order", unique: true
    t.index ["plan_id"], name: "index_plan_stops_on_plan_id"
  end
  ...
  create_table "restaurants", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["venue_id"], name: "index_restaurants_on_venue_id"
  end
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.geography "home_area", limit: {:srid=>4326, :type=>"st_point", :geographic=>true}
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  add_foreign_key "events", "pandals"
  add_foreign_key "favorites", "pandals"
  add_foreign_key "favorites", "users"
  add_foreign_key "pandal_images", "pandals"
  add_foreign_key "pandal_nearbies", "pandals"
  add_foreign_key "pandals", "venues"
  add_foreign_key "plan_stops", "pandals"
  add_foreign_key "plan_stops", "plans"
  add_foreign_key "plans", "users"
  add_foreign_key "restaurants", "venues"
end
